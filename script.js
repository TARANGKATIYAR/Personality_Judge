...
// catch all values to generate avatar when clicked
document.getElementById("avatar-form").addEventListener("submit", function(e){

  let data = []

  let stage = document.getElementById("fields_form").stage.value
  let talk = document.getElementById("fields_form").talk.value
  let sport = document.getElementById("fields_form").sport.value
  let friends = document.getElementById("fields_form").friends.value
  let profession = document.getElementById("fields_form").profession.value
  let skilled = document.getElementById("fields_form").skilled.value
  let zodiac = document.getElementById("fields_form").zodiac.value
  let emotional = document.getElementById("fields_form").emotional.value
  let creative = document.getElementById("fields_form").creative.value
  let group = document.getElementById("fields_form").group.value
  let freetime = document.getElementById("fields_form").freetime.value

  // console.log(stage, talk, sport)

  document.getElementById("description_para").innerHTML = "According to the information given by you above, you are currently in " + stage + ". You are also a " + talk + " person in terms of talking and communicating with someone. You also have a good interest in the sport named " + sport + '. You are actually ' + friends +  ' in making friends which can be a drawback as well benefit for you. You are ' + profession + 'by profession. You are also skilled at ' + skilled + 'according to the data that I received. You zodiac sign is also ' + zodiac + 'and its traits are followed by you as a person on the planet. According to yourself you are ' + emotional + 'in emotions and ' + creative + ' in creativeness. You also ' + group + ' enjoy group activities. You even like to ' + freetime + ' in free time like me.'
